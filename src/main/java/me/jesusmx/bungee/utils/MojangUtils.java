...
public class MojangUtils {
    ...
    private static UUID parseUUIDFromString(String uuidAsString) {
        String[] parts = { "0x" + uuidAsString.substring(0, 8), "0x" + uuidAsString.substring(8, 12), "0x" + uuidAsString.substring(12, 16), "0x" + uuidAsString.substring(16, 20), "0x" + uuidAsString.substring(20, 32) };
        ...
        return new UUID(mostSigBits, leastSigBits | Long.decode(parts[4]));
    }
}
